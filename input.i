...
<br>
<div>The time derivative of temperature in every node of the pipe is set to zero and temperature is set equal to the specified signal at the current time.</div>
<br>
<!------------------------------------------------------------------------------------------------>
...
<div>Currently available signals (under development):</div>
   <div style='margin:0 0 0 20px'>
   <div><code>time</code>: current time (s).</div>
</div>
<br>
<!------------------------------------------------------------------------------------------------>
